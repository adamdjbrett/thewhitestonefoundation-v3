...
- ~~The footer needs to say: The Whitestone Foundation, dba Whitestone Publications, is a Boulder, Colorado-registered 501(c)(3) non-profit corporation dedicated to fostering critical thought for the public interest.~~
- ~~In the footer, link to 11ty and the RSS feed for the theme. We are using https://phosphoricons.com/?q=rss. Goodbye, Font Awesome.~~
~~- Use the transparent PNG logo and have it appear at 18x18, 24x24, or 32x32 pixels, whatever works best for the site we want the logo to pop with~~
~~- on index.md programs make the link: section work and have a button open the link. add link_title: link_url:~~
